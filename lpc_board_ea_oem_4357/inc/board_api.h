...
/**
 * @brief	Basic implementation of delay function
 * @param	us	: Number of microseconds to delay
 * @return	None
 * @note	The purpose is to avoid having local functions everywhere with for loops
 * and other kinds of delays and instead move those (possibly still for-loops) to one
 * common place.
 */
